...
class TimeSheetController extends Controller
{
    ...
    public function newAction(Request $request)
    {
         ...
         */
        public
        function showAction(TimeSheet $timeSheet)
        {
         ...
         */
        public
        function editAction(Request $request, TimeSheet $timeSheet)
        {
            $deleteForm = $this->createDeleteForm($timeSheet);
         ...
         */
        public
        function deleteAction(Request $request, TimeSheet $timeSheet)
        {
