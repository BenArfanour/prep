...
class Projet extends \AppBundle\Entity\Projet implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'nom', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'startDate', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'endDate', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'client', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'projet'];
        }
