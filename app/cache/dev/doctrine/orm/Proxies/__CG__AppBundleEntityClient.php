...
class Client extends \AppBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'nom', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'pays', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'projets'];
        }
